	...
	public Puntuaciones() {
		...
		cargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				LabelUsuario3.setText(diez[1].getUser());
				LabelPuntuacion3.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario4.setText(diez[1].getUser());
				LabelPuntuacion4.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario5.setText(diez[1].getUser());
				LabelPuntuacion5.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario6.setText(diez[1].getUser());
				LabelPuntuacion6.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario7.setText(diez[1].getUser());
				LabelPuntuacion7.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario8.setText(diez[1].getUser());
				LabelPuntuacion8.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario9.setText(diez[1].getUser());
				LabelPuntuacion9.setText(String.valueOf(diez[1].getPuntos()));
				LabelUsuario10.setText(diez[1].getUser());
				LabelPuntuacion10.setText(String.valueOf(diez[1].getPuntos()));
			}
		});
