...
public class JuegoPrincipiante extends JPanel {
	...
	public JuegoPrincipiante() {
		...
		LabelBienvenida.setBounds(10, 11, 1180, 32);
		add(LabelBienvenida);
		...
		LabelPuntuacion.setBounds(535, 471, 655, 40);
		add(LabelPuntuacion);
		...
		LabelSuma.setBounds(646, 54, 150, 150);
		add(LabelSuma);
		LabelSuma.addMouseListener(new listenerEtiquetaSuma());		
		...
		LabelResta.setBounds(966, 54, 150, 150);
		add(LabelResta);
		LabelResta.addMouseListener(new listenerEtiquetaResta());	
		...
		JTextOperacion.setBounds(534, 215, 656, 57);
		add(JTextOperacion);
		...
		ButtonMathdice.addMouseListener(new listenerMathDice());	
		ButtonMathdice.setFont(new Font("Modern No. 20", Font.PLAIN, 20));
		ButtonMathdice.setBounds(535, 283, 655, 57);
		add(ButtonMathdice);
		
		//Botón para volver a jugar
		btnReset = new JButton("RESET");
		btnReset.addMouseListener(new listenerReset());	
		btnReset.setEnabled(false);
		btnReset.setFont(new Font("Modern No. 20", Font.PLAIN, 20));
		btnReset.setBounds(535, 351, 655, 57);
		add(btnReset);
		...
		LabelResultado.setBounds(535, 420, 655, 40);
		add(LabelResultado);
		...
		LabelAciertosSeguidos.setBounds(535, 535, 655, 40);
	...
	//ETIQUETA SUMA
	private class listenerEtiquetaSuma implements MouseListener {
		//Formato que tiene que aparecer en una inner class de un mouseListener
		@Override
		public void mouseClicked(MouseEvent arg0) {}
		@Override
	...
	//ETIQUETA RESTA
	private class listenerEtiquetaResta implements MouseListener {
		//Formato que tiene que aparecer en una inner class de un mouseListener
		@Override
		public void mouseClicked(MouseEvent arg0) {}
		@Override
	...
	//BOTÓN MATHDICE
	private class listenerMathDice implements MouseListener {
		//Formato que tiene que aparecer en una inner class de un mouseListener
		@Override
		public void mouseClicked(MouseEvent arg0) {}
		@Override
		...
		@Override
		public void mousePressed(MouseEvent e) {
			LabelDado_3_1.removeMouseListener(this);
			LabelDado_3_2.removeMouseListener(this);
	...
	//BOTÓN RESET
	private class listenerReset implements MouseListener {
		//Formato que tiene que aparecer en una inner class de un mouseListener
		@Override
		public void mouseClicked(MouseEvent arg0) {}
		@Override
